...
T = TypeVar("T", bound="TemplatePreviewResponse")
...
class TemplatePreviewResponse:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        template_preview_response.additional_properties = d
        return template_preview_response
