...
) -> AuthErrorDetail | HTTPValidationError | PluginDetail | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[AuthErrorDetail | HTTPValidationError | PluginDetail]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        AuthErrorDetail | HTTPValidationError | PluginDetail
    """
